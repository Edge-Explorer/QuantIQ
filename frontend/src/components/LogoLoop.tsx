  ...
  ({
    ...
    const renderLogoItem = useCallback(
      (item: LogoItem, key: string) => {
        ...
        const imgItem = item as LogoImageItem;
        ...
        const itemHref = isNodeItem ? nodeItem.href : imgItem.href;
        const itemAriaLabel = isNodeItem ? (nodeItem.ariaLabel ?? nodeItem.title) : (imgItem.alt ?? imgItem.title);
